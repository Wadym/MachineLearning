...
{
    public class ClusterModels
    {
        public ClusterModels()
        {
        }
        #region ClusterModelsCfg
            ...
            public List<int> IndexOfOutput
        {
            ...
            private List<double> iteration_max = new List<double>();
            public List<double> IterationMax        
            {
